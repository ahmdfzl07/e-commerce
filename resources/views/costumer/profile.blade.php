                ...
                <div class="card-body">
                    ...
                    <div>
                        <form id="profileForm" method="POST" action="{{ route('costumer.updateProfile') }}">
                            ...
                            <div class="col-md-12 form-group">
                                <input type="email" class="form-control" id="email" name="email" placeholder="Email Alamat" value="{{ $customer->email }}" required>
                            </div>
                            ...
                            <div class="col-md-12 form-group">
                                <input type="text" class="form-control" id="address" name="address" placeholder="Your Alamat" value="{{ $customer->address }}" required autocomplete="address">
                            </div>
